...
export default function NewPratoPage({ params }: { params: { locale: string } }) {
    const { locale } = params
    ...
    return (
        <section className="max-w-3xl mx-auto py-10">
            ...
            <form onSubmit={submit} className="space-y-4">
                ...
                <label><input type="checkbox" name="is_pintxo" checked={form.is_pintxo} onChange={onChange}/> Pintxo</label>
                <label><input type="checkbox" name="is_vegan" checked={form.is_vegan} onChange={onChange}/> Vegano</label>
                <label><input type="checkbox" name="is_vegetariano" checked={form.is_vegetariano} onChange={onChange}/> Vegetariano</label>
                <label><input type="checkbox" name="is_drink" checked={form.is_drink} onChange={onChange}/> Drink</label>
                <label><input type="checkbox" name="is_alcoolico" checked={form.is_alcoolico} onChange={onChange}/> Alcoólico</label>
                <label><input type="checkbox" name="is_soft" checked={form.is_soft} onChange={onChange}/> Soft</label>
                <label><input type="checkbox" name="is_outro" checked={form.is_outro} onChange={onChange}/> Outro</label>
